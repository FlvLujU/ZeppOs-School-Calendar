  ...
  build() {
      ...
      if (tareas[asignatura].length > 0) {
        ...
        for (const [i, tarea] of tareas[asignatura].entries()) {
          ...
          hmUI.createWidget(hmUI.widget.FILL_RECT, {
            x: 10,
            y: 40 + 85 * c + 6, // Usa el contador para posicionar correctamente
            w: 390 - 20,
            h: 80,
            color: 0xeba5a0,
            radius: 12
          ...
          hmUI.createWidget(hmUI.widget.FILL_RECT, {
            x: 20,
            y: 50 + 85 * c + 6, // Usa el contador para posicionar correctamente
            w: 15,
            h: 60,
    ...
    for (const asignatura in examenes) {
      if (examenes[asignatura].length > 0) {
        hmUI.createWidget(hmUI.widget.TEXT, {
          x: 45,
          y: 10 + 80 + 85 * c + 10 + 5 + 6, // Usa el contador para posicionar correctamente
          w: 390 - 20,
          h: 80,
          color: 0x000000,
        ...
        for (const [i, examen] of examenes[asignatura].entries()) {
          ...
          hmUI.createWidget(hmUI.widget.FILL_RECT, {
            x: 10,
            y: 10 + 80 + 85 * c + 10 + 5 + 40 + 85 * d + 6, // Usa el contador para posicionar correctamente
            w: 390 - 20,
            h: 80,
            color: 0xeba5a0,
            radius: 12
          ...
          hmUI.createWidget(hmUI.widget.FILL_RECT, {
            x: 20,
            y: 10 + 80 + 85 * c + 10 + 5 + 50 + 85 * d + 6, // Usa el contador para posicionar correctamente
            w: 15,
            h: 60,
            color: subjectsColors[colourNum],
            radius: 12
    ...
    for (const asignatura in proyectos) {
      if (proyectos[asignatura].length > 0) {
        hmUI.createWidget(hmUI.widget.TEXT, {
          x: 45,
          y: 10 + 80 + 85 * c + 10 + 5 + 50 + 85 * d + 10 + 5 + 6,
          h: 80,
          color: 0x000000,
          text: `Proyectos:`
        });
        for (const [i, proyecto] of proyectos[asignatura].entries()) {
          ...
          hmUI.createWidget(hmUI.widget.FILL_RECT, {
            x: 10,
            y: 10 + 80 + 85 * c + 10 + 5 + 40 + 85 * d + 10 + 5 + 60 + 85 * e + 6,
            w: 390 - 20,
            h: 80,
            color: 0xeba5a0,
            radius: 12
          ...
          hmUI.createWidget(hmUI.widget.FILL_RECT, {
            x: 20,
            y: 10 + 80 + 85 * c + 10 + 5 + 50 + 85 * d + 10 + 5 + 60 + 85 * e + 6, // Usa el contador para posicionar correctamente
            w: 15,
            h: 60,
            color: subjectsColors[colourNum],
            radius: 12
          ...
          hmUI.createWidget(hmUI.widget.TEXT, {
            x: 45,
            y: 10 + 80 + 85 * c + 10 + 5 + 50 + 85 * d + 10 + 5 + 70 + 85 * e - 5 + 6, // Usa el contador para posicionar correctamente
            w: 390 - 20,
            h: 80,
            color: 0x000000,
            text: txt, // Mostrar la asignatura y la tarea
    ...
    let minH = 10 + 80 + 85 * c + 10 + 5 + 40 + 85 * d + 10 + 5 + 60 + 85 * e + 30
    if(minH < 450){
      minH = 450
    }
